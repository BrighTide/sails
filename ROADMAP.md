...
Populate IDs rather than full records | [@BrighTide](https://github.com/BrighTide) | The option to, instead of populating the full record, just have the relation's id when dealing with all types of relations would be really handy when you're doing all your joining on the frontend because you want a single source of truth for that record.
